...
- Shortcuts are created in the project root folder for each `.exe`, `.bat`, `.cmd`, `.ps1`, `.vbs`, `.wsf`, `.js`, and `.html`/`.htm` file found in `main/`. PowerShell shortcuts include an execution policy bypass.
